          ...
          <div className="fbh">
            <div className="fb1">
              <div className="fbh mb8">
                ...
                <div>当前项目包含 {project.arts.length} 块大屏</div>
              </div>
              <div className={c("p8 mb8", s.removeProjectNote)}>
                删除项目会同时删除项目中包含的所有大屏、成员信息和数据信息，且删除后不可恢复。删除前请考虑是否需要备份项目。
              </div>
              <div
                className={s.removeProjectButton}
                onClick={project.removeConfirm}
              >
                删除项目
              </div>
            </div>
