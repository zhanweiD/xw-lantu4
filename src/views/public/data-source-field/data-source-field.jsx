...
const DataSourceField = observer(
  ({data, model, isView, testBtn, onClick = () => {}}) => {
    ...
    return (
      <div className={c(s.databaseMargin)}>
        ...
        <TextField
          ...
          value={remark}
          onChange={(value) =>
            data.set({modelConfig: {...data.modelConfig, remark: value}})
          }
          readOnly={isView}
        />
        {isView ? (
          ...
          <SelectField
            ...
            isFixed={false}
            onChange={(value) =>
              data.set({modelConfig: {...data.modelConfig, type: value}})
            }
          />
        )}
        <TextField
          ...
          readOnly={isView}
          onChange={(value) =>
            data.set({modelConfig: {...data.modelConfig, host: value}})
          }
        />
        <TextField
          label="用户名"
          ...
          readOnly={isView}
          onChange={(value) =>
            data.set({modelConfig: {...data.modelConfig, userName: value}})
          }
        />
        <TextField
          label="密码"
          ...
          readOnly={isView}
          onChange={(value) =>
            data.set({modelConfig: {...data.modelConfig, password: value}})
          }
        />
        ...
        <NumberField
          ...
          readOnly={isView}
          onChange={(value) =>
            data.set({modelConfig: {...data.modelConfig, port: value}})
          }
        />
