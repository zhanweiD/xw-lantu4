...
export default {
  ...
  stackLine: (container, theme) =>
    createSchema(container, theme, createStandardLayout, "stack", false, false),
  area: (container, theme) =>
    createSchema(
      container,
      theme,
      createStandardLayout,
