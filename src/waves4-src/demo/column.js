      ...
      // 矩形图层
      {
        ...
        style: {
          ...
          text: {
            ...
            format: [
              "number",
              {decimalPlace: 0, isThousandth: mode === "waterfall"}
            ]
          }
        },
        animation: {
...
export default {
  groupColumn: (container, theme) =>
    createSchema(
      container,
      theme,
      getStandardLayoutWithBrush,
      "column",
      "group",
      false
    ),
  stackColumn: (container, theme) =>
    createSchema(
      container,
      theme,
      getStandardLayoutWithBrush,
  ...
  intervalColumn: (container, theme) =>
    createSchema(
      container,
      theme,
      getStandardLayoutWithBrush,
  ...
  waterfallColumn: (container, theme) =>
    createSchema(
      container,
      theme,
      getStandardLayoutWithBrush,
  ...
  groupLineColumn: (container, theme) =>
    createSchema(
      container,
      theme,
      getStandardLayoutWithBrush,
  ...
  stackLineColumn: (container, theme) =>
    createSchema(
      container,
      theme,
      getStandardLayoutWithBrush,
