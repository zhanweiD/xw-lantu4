...
export default {
  rectHeatmap: (container, theme) =>
    createSchema(container, theme, createStandardLayout, "rect"),
  circleHeatmap: (container, theme) =>
    createSchema(container, theme, createStandardLayout, "circle")
}
