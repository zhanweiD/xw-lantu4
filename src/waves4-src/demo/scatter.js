...
export default {
  scatter: (container, theme) =>
    createSchema(container, theme, getStandardLayoutWithBrush, "scatter"),
  bubble: (container, theme) =>
    createSchema(container, theme, getStandardLayoutWithBrush, "bubble")
}
