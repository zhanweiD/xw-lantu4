export default () => {
  ...
  return {
    ...
    data: [
      ...
      [[120, 30], [randomNum(-60, 180), randomNum(-30, 70)], '终点1', '起点'],
      [[120, 30], [randomNum(-60, 180), randomNum(-30, 70)], '终点2', '起点'],
      [[120, 30], [randomNum(-60, 180), randomNum(-30, 70)], '终点3', '起点'],
      [[120, 30], [randomNum(-60, 180), randomNum(-30, 70)], '终点4', '起点'],
      [[120, 30], [randomNum(-60, 180), randomNum(-30, 70)], '终点5', '起点'],
