  ...
  [
    ...
    ({mapOption, getOption}) => {
      const mapping = [
        ...
        // ['base.color.colorType', 'style.arc.colorType'],
        // ['base.color.gradientColor', 'style.arc.gradientColor'],
  ...
  [
    ...
    ({mapOption}) => {
      const mapping = [
        ...
        ['color.colorType', 'style.arc.colorType'],
        ['color.gradientColor', 'style.arc.gradientColor'],
        // 圆心
